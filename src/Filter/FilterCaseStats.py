...
class FilterCaseStats:
    ...
    def __init__(self, state, case_df):
        """
    ...
    def get_case_stats(self):
        ...
        """
        final_response = {}
        filtered_dataframe = self.filter_state(self.case_df, self.state)
        final_response[self.state] = self.get_stats(filtered_dataframe, self.state)
        filtered_dataframe = self.filter_state(self.case_df, "India")
